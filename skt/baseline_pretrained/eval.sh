#!/bin/bash
#SBATCH --job-name=baseline_pretrained_eval
#SBATCH --partition=l40s-gpu
#SBATCH --nodes=1
#SBATCH --gpus-per-node=2
#SBATCH --time=08:00:00
#SBATCH --output=/fsx/rlwrld/youngwoong_cho/logs/baseline_pretrained_eval_%j.out
#SBATCH --error=/fsx/rlwrld/youngwoong_cho/logs/baseline_pretrained_eval_%j.err
#SBATCH --comment="baseline_pretrained: eval-only on existing final checkpoint"
