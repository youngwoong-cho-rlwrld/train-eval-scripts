...
CHECKPOINT="/fsx/rlwrld/youngwoong_cho/checkpoints/onboard_cube_box_left_scratch/checkpoint-30000"
EVAL_SET="${EVAL_SET:-0cm}"
GPU_LABEL="${GPU_LABEL:-l40s}"
TIMESTAMP="$(date +%Y%m%d%H%M%S)"
OUTPUT_DIR="/fsx/rlwrld/youngwoong_cho/eval_results/onboard_cube_box_left_scratch/${EVAL_SET}_${GPU_LABEL}_${TIMESTAMP}"
