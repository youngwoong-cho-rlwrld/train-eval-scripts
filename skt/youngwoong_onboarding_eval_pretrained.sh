#!/bin/bash
#SBATCH --job-name=eval-onboarding-youngwoong-pretrained
#SBATCH --partition=l40s-gpu_background
#SBATCH --nodes=1
...
CHECKPOINT="/fsx/rlwrld/youngwoong_cho/checkpoints/onboard_cube_box_left_pretrained/checkpoint-30000"
EVAL_SET="${EVAL_SET:-0cm}"
GPU_LABEL="${GPU_LABEL:-l40s}"
TIMESTAMP="$(date +%Y%m%d%H%M%S)"
OUTPUT_DIR="/fsx/rlwrld/youngwoong_cho/eval_results/onboard_cube_box_left_pretrained/${EVAL_SET}_${GPU_LABEL}_${TIMESTAMP}"
