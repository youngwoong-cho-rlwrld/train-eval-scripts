#!/bin/bash
#SBATCH --job-name=baseline_scratch_tunevisual
#SBATCH --partition=rlwrld
#SBATCH --nodes=1
#SBATCH --gpus-per-node=4
#SBATCH --time=48:00:00
#SBATCH --output=/rlwrld2/home/youngwoong_cho/logs/baseline_scratch_tunevisual_%j.out
#SBATCH --error=/rlwrld2/home/youngwoong_cho/logs/baseline_scratch_tunevisual_%j.err
#SBATCH --comment="baseline_scratch_tunevisual: no torque, with random-diffusion (action head from scratch)"
