...
CHECKPOINT="/rlwrld2/home/youngwoong_cho/checkpoints/onboard_cube_box_left_pretrained/checkpoint-30000"
EVAL_SET="${EVAL_SET:-0cm}"
GPU_LABEL="${GPU_LABEL:-a100}"
TIMESTAMP="$(date +%Y%m%d%H%M%S)"
OUTPUT_DIR="/rlwrld2/home/youngwoong_cho/eval_results/onboard_cube_box_left_pretrained/${EVAL_SET}_${GPU_LABEL}_${TIMESTAMP}"
