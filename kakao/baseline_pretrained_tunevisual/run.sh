#!/bin/bash
#SBATCH --job-name=baseline_pretrained_tunevisual
#SBATCH --partition=rlwrld
#SBATCH --nodes=1
#SBATCH --gpus-per-node=4
#SBATCH --time=48:00:00
#SBATCH --output=/rlwrld2/home/youngwoong_cho/logs/baseline_pretrained_tunevisual_%j.out
#SBATCH --error=/rlwrld2/home/youngwoong_cho/logs/baseline_pretrained_tunevisual_%j.err
#SBATCH --comment="baseline_pretrained_tunevisual: no torque, no random-diffusion"
